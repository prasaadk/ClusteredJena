...
public class LineIndexerOutputFormat extends MultipleTextOutputFormat<Text, Text> {
	...
	protected RecordWriter<Text, Text> getBaseRecordWriter(FileSystem fs, JobConf job, String name, Progressable progress) throws IOException {
		...
		return new LineIndexOutputWriter<Text, Text>(job, name, progress);
	}

	protected String generateFileNameForKeyValue(Text key, Text value, String name) {		
		return "NoFileUsedAtAll";
	}
}
