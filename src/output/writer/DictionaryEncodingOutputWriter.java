...
public class DictionaryEncodingOutputWriter<K, V> implements RecordWriter<K, V> {
	
	 Logger log = LoggerFactory.getLogger(DictionaryEncodingOutputWriter.class);
	 ...
	 public DictionaryEncodingOutputWriter(JobConf job, String name, Progressable progress) {
		 try {
