...
public class DictionaryTripleReader extends BaseRecordReader<Text,Triple>{
	...
	private static Logger log = LoggerFactory.getLogger(DictionaryTripleReader.class);
	...
	public DictionaryTripleReader(Configuration job, MultiFileSplit input) throws IOException {
		super(job, input);		
	}
