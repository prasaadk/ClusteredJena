...
public class NTripleReader extends BaseRecordReader<Text,Triple>{
	...
	private static Logger log = LoggerFactory.getLogger(NTripleReader.class);
	...
	public NTripleReader(Configuration job, MultiFileSplit input) throws IOException {
		super(job, input);		
	}
